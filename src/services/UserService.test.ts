...
describe('Testing user service', () => {
    ...
    beforeAll(async () => {
        ...
        // A função sync, sincroniza o model com a tabela no banco de dados
        // Se existir um usuário, ele deleta a tabela e cria uma nova, isso porque definimos o force: true
        // E Se não existir ele cria
    });
    ...
    it('should create a new user', async () => {
        ...
        // Já falamos desse match (toBeInstanceOf), mas perceba o atributo not, que é uma negação do match a sua frente
    });
